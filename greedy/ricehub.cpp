 ...
 * Then the sum of the distances for i and j is just X[j]-X[i] no matter where the ricehub is placed.
 * Now let's say you have farmers i+1 and j-1. Then the ricehub should be placed in between X[i+1] and X[j-1].
