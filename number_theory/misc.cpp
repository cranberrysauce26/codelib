...
// so if the modulos are m1, m2, ..., mk, then there is a solution mod M = m1*m2*...*mk
// IMPORTANT CONDITION: M DOES NOT OVERFLOW ON LONG LONG
// eq is a vector of pairs (a, mod) where x = a (mod mod)
// STATUS: UNTESTED
